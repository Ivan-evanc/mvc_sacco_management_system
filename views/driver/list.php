      ...
      <div class="table table-responsive">
          ...
          <thead>
           ...
           <tbody id="mytable">
           	...
           	$query="SELECT * from tbl_users WHERE user_role_id='4' ORDER BY id ASC";
            ...
            while($row=mysqli_fetch_assoc($result)){
              ...
              <td><?php echo $row['id'];?></td>
           		...
           		<td>
           			<a href="../driver/edit?email=<?php echo $row['email'];?>"><button class="btn btn-info btn-sm"><i class="fa fa-edit"></i></button></a>
           		</td>
           	</tr>
           	<?php } ?>
